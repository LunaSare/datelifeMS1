...
datelifeplot::plot_node_ages(pp,
               ...
               edge.width = 3,
               cex_tiplabels = 2,
               calibration_ages = calib_summ,
               pch_calibration = 18,
               pch_calibration_color = color_studies,
               pch_calibration_cex = 2,
               bars_lwd = 10,
               legend_cex = 1,
               axis_label = "",
               legend_x = 0,
...
#pdf(file = "../figures/figure1/opentree_topology.pdf",
#png(filename = "../figures/figure1/opentree_topology.png",
    height = 5,
    width = 5,
    bg = "transparent")
...
names(color_summary) <- c("Median pairwise ages")

svg(filename = "../figures/figure1/median_and_calibration_ages.svg",
    height = 5,
    width = 5.5)
datelifeplot::plot_node_ages(phylo_median,
               ...
               cex_tiplabels = 2,
               calibration_ages = calib_summ,
               summary_ages = mm_summ,
               pch_summary = "X",
               pch_calibration = 18,
               pch_calibration_color = color_studies,
               pch_summary_color = color_summary,
               pch_summary_cex = 2,
               pch_calibration_cex = 2,
               bars_lwd = 15,
               legend_cex =1.4,
