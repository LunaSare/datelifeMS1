...
TODO: verify that `check_conflicting_calibrations` is working good adn being used where needed
...
- use asterisks to show median ages that were not used as calibrations - DONE
...
```{r}
#  devtools::load_all("../../datelifeplot")
svg(file = paste0(writing_dir, "/median_and_calibration_ages-congruified.svg"),
    height = 30,   
    width = 15)
source("../R/plot_node_ages2_custom.R")
ape::nodelabels(cex = 0.5, adj = 1)
dev.off()
```        
