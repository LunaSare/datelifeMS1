...
median(aa["Platyspiza crassirostris", c("Pheucticus tibialis"),], na.rm = TRUE)
median(aa["Platyspiza crassirostris", c("Rhodothraupis celaeno"),], na.rm = TRUE)
```
Mistery solved!
Burns et al. 2014 study contains data for one taxon pair but not the other. Moreover, the age of that node differs wildly from the rest of the data ppoints. This results in median ages for two taxon pairs that refer to the same node that are very different. These 
