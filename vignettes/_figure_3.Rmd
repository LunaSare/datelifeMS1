...
names(color_studies)
color_studies_new[c("Hedges et al. 2015 - chronogram 1", "Hedges et al. 2015 - chronogram 2")] <- c("#EFCD3AFF", "#FCB036FF") # yellow colors obtained in vignettes/figure-small-example.Rmd
