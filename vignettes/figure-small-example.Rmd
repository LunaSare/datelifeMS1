...
## Getting species names for a datelife search chronograms
...
```{r}
summary_table <- read.csv(file = "../tables/table-fringillidae-small-example-summary.csv")
```

```{r}
# Export PDF

pdf(paste0("../tables/table-fringillidae-small-example-summary.pdf"), 
     width = 10, 
     height = 8)
