...
var_description_2 <- c("Names of nodes from the tree topology used for the dating analysis",
                       ...
                       "Standar deviation of node age, in Million years")
```
...
for (file_name in csv_file_names) {
  ...
  tt <- utils::read.csv(file = paste0("../dryad/", file_name), header = TRUE, row.names = NULL)
  # remove the column with row numbers:
  tt <- tt[,-1]
  # create the description text
  var_list <- gsub("[.]", " ", colnames(tt))
  var_list <- paste0("\\tab ", var_list, ": ", var_descriptions[[file_name]], "\\n ")
  var_list <- paste0(var_list, collapse = "")
  print(var_list)
  text <- paste(text, 
                paste("DATA-SPECIFIC INFORMATION FOR:", file_name, "\\n "),
                "\\n1. Number of variables/columns:", ncol(tt), "\\n ",
                "\\n2. Number of cases/rows:", nrow(tt), "\\n ",
                "\\n3. Variable List \\n ", var_list,
