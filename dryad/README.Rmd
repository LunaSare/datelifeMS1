...
We showcased the application of the package with two different biological examples.
...
File 7 Name: Sanchez-Reyes_etal_2022_figure_3_chronogram_small_example.tre    
File 7 Description: Newick version of chronogram from the small example shown in Figure 3 of the manuscript (https://www.biorxiv.org/content/10.1101/782094v2).

File 8 Name: Sanchez-Reyes_etal_2022_figure_4A_topology_finches_mrca.tre    
File 8 Description: Newick version of topology extracted from the Open Tree of Life synthetic tree, shown in Figure 4A of the manuscript (https://www.biorxiv.org/content/10.1101/782094v2).

File 9 Name: Sanchez-Reyes_etal_2022_figure_4B_topology_finches_ncbi.tre    
File 9 Description: Newick version of topology extracted from the Open Tree of Life synthetic tree, shown in Figure 4B of the manuscript (https://www.biorxiv.org/content/10.1101/782094v2).

File 10 Name: Sanchez-Reyes_etal_2022_figure_5_chronogram_finches_example.tre    
File 10 Description: Newick version of chronogram from the finch example shown in Figure 5 of the manuscript (https://www.biorxiv.org/content/10.1101/782094v2).

File 11 Name: Sanchez-Reyes_etal_2022_supplementary_figure_S1.pdf    
File 11 Description: PDf file showing a topology extracted from OpenTree of Life's synthetic tree, of 2,333 tips and 1,305 internal nodes encompassing bird species within the family Fringillidae following the NCBI taxonomy (black), as well as all other bird species that share the same Most Recent Common Ancestor (MRCA) node in OpenTree's synthetic tree (purple). 

File 12 Name: Sanchez-Reyes_etal_2022_supplementary_figure_S2.pdf    
File 12 Description: PDf file showing a subtree topology of 289 tips and 253 internal nodes resulting from pruning species from supplementray figure S1 (purple branches), that do not belong to the family Fringillidae according to the NCBI taxonomy. 

File 13 Name: Sanchez-Reyes_etal_2022_supplementary_figure_S3.pdf    
File 13 Description: PDf file showing the Fringillidae median summary chronogram resulting from a DateLife analysis. 

File 14 Name: Sanchez-Reyes_etal_2022_supplementary_figure_S4.pdf    
File 14 Description: PDf file showing results of cross validation analysis of datelife's chronogram generating functions. 
