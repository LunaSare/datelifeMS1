...
BLADJ takes an initial topologies without any branch length data, fixes node ages that have calibration data, and distributes time between nodes with no data evenly between calibrated nodes.
This has proven effective to minimize age variance in the resulting chronogram and useful for ecological analyses (Webb et al., 2008).
...
Alternatively, the user can use the MrBayes (Huelsenbeck \& Ronquist, 2001; Ronquist \& Huelsenbeck, 2003) approach in DateLife uses the calibrations as priors on node ages.
