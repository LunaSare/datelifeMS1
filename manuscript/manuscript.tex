...
The latest implementation of the \texttt{datelife} R package is available on CRAN (v0.6.2; Sanchez-Reyes et al. (2022)) and features an algorithm for automatic curation and maintenance of an open database composed of chronograms pulled from OpenTree's public repository (McTavish et al., 2015), and methods to summarize chronograms and compare them.
