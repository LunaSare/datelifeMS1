...
\caption{Topologies obtained from OpenTree's synthetic phylogeny. A) Topology od 2333 tips, encompassing bird species within the Fringillidae following the NCBI taxonomy (black) as well as all other bird species that share the same mrca node in the synthetic tree (purple). B) Topology encompassing bird species within the Fringillidae only, resulting from pruning purple branches from topology A.
