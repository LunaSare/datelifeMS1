...
%DIF ADD manuscript.tex                  Tue Nov  7 20:35:23 2023
...
}\DIFdelend \DIFaddbegin \DIFadd{6946
}\DIFaddend 
...
(\DIFdelbegin \DIFdel{Jun 11}\DIFdelend \DIFaddbegin \DIFadd{Nov 07}\DIFaddend , 2023),
...
While using initial branch length data is the golden standard for phylogenetic dating analyses, estimating trees with branch lengths proportional to substitution rates per site requires obtaining primary data, assembling and curating a homology \DIFaddbegin \DIFadd{(orthology) }\DIFaddend hypothesis, and choosing and implementing a method for phylogenetic inference.
