...
%DIF ADD manuscript.tex                  Tue Feb 21 00:17:10 2023
...
Knowledge of the }\DIFdelend \DIFaddbegin \DIFadd{time-- represent key data on }\DIFaddend evolutionary time frame \DIFdelbegin \DIFdel{of organisms is key for research in the natural sciences.
It also represent valuable information }\DIFdelend for \DIFaddbegin \DIFadd{the study of natural processes in many areas of biological research.
Chronograms also provide valuable information that can be used for }\DIFaddend education, science communication, and policy decisions.
...
Software such as DateLife can help }\DIFaddend increase awareness of the existing variation in alternative hypothesis of evolutionary time \DIFaddbegin \DIFadd{frame }\DIFaddend for the same organisms, and can \DIFdelbegin \DIFdel{foster }\DIFdelend \DIFaddbegin \DIFadd{support }\DIFaddend exploration of the effect of alternative \DIFdelbegin \DIFdel{evolutionary timing hypotheses on the results of }\DIFdelend \DIFaddbegin \DIFadd{chronogram hypotheses on }\DIFaddend downstream analyses, providing a framework for a more informed interpretation of evolutionary results.
...
}\DIFdelend \DIFaddbegin \DIFadd{6111
}\DIFaddend 
...
(\DIFdelbegin \DIFdel{Jun 22, 2022}\DIFdelend \DIFaddbegin \DIFadd{Feb 21, 2023}\DIFaddend ),
...
\textbf{\emph{\DIFadd{With no branch lengths.--}}}
...
\begin{center}
\emph{Effects \DIFaddbegin \DIFadd{of Phylogenetic Sampling }\DIFaddend on Downstream Analyses}
\end{center}
...
Treplin, S., Siegert, R., Bleidorn, C., Thompson, H. S., Fotso, R., \& Tiedemann, R. (2008). Molecular phylogeny of songbirds (aves: Passeriformes) and the relative utility of common nuclear marker loci. \emph{Cladistics}, \emph{24}(3), 328--349\DIFaddbegin \DIFadd{.
}

\leavevmode\hypertarget{ref-uyeda2017evolution}{}%DIF > 
\DIFadd{Uyeda, J. C., Pennell, M. W., Miller, E. T., Maia, R., \& McClain, C. R. (2017). The evolution of energetic scaling across the vertebrate tree of life. }\emph{\DIFadd{The American Naturalist}}\DIFadd{, }\emph{190}(2)\DIFadd{, 185--199}\DIFaddend .
