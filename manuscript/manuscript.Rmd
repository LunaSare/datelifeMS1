...
<!--_I rewroded a bit, and removed a Boyle citation because it sounded like you were using their TNRS - but you aren't right?  -->
...
This matrix consists of ... ???? the pairwise distance between pairs of query taxa whcih are in that input tree, in units of millions of years. <!-- is that true? -->
...
For each node in the output tree topology, the pairiwise distances that traverse that node are ..???
Under the SDM criterions ??? what happens??
...
<!--Huh? can you run MrBayes in DateLife?-->
