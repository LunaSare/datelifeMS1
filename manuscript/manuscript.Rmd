...
We illustrate the DateLife workflow using a family within the Passeriform birds encompassing the true finches, Fringillidae, as case study. On a small example, we analyse 6 bird species, and show all steps of the workflow (Fig. \ref{fig:figure2}). As a second example, we analyse 289 species in the family Fringillidae that are included in the NCBI taxonomy (Fig. \ref{fig:fringillidages}).
