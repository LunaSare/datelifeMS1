...
To perform a cross validation analysis of the DateLife workflow, we took tree topologies from source chronograms and used age data from all other source chronograms as fixed calibrations with the program BLADJ (Fig. \ref{fig:cvXY}).
...
*I still need to double check results to confirm or change any of the following descriptions:*

The ages of internal nodes were recovered with a high precision in almost all cases (except for studies 3, and 5; Fig. \ref{fig:cvXY}).
Maximum tree ages were only recovered in one case (study 2; Fig. \ref{fig:cvXY}).
