...
phylogenetic information (such as the OpenTree synthetic tree), and we use the patristic distances as calibrations to date that topology (with BLADJ for now). TODO ADD FIGURE: mock example explaining difference between using summary ages and raw ages to calibrate a topology. Then show it in the biological example. This will show what happens if a tree (phylogenetic conflict) or node (age) do not agree.
