...
The latest implementation of the `datelife` R package is available on CRAN (v`r packageVersion("datelife")`; @datelifeR) and features an algorithm for automatic curation and maintenance of an open database composed of chronograms pulled from OpenTree's public repository [@mctavish2015phylesystem], and methods to summarize chronograms and compare them.
