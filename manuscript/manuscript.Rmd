...
The algorithm starts by fixing ages for nodes with calibration data upon the given topology. Then, it distributes time for nodes with no data evenly between calibrated nodes, minimizing age variance in the resulting chronogram [@Webb2008].
This approach has has proven useful for ecological analyses that require age data [@Webb2008].
