...
> NOTE: do you know how it decides which one to drop if two calibrations conflict? The parent or the child? It would drop both. It basically drops any calibration for any given node that are older than any calibration of the parent node, and younger than any calibration of children nodes.
